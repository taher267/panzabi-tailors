<div class="container-fluid">
    <style type="text/css">
        #dalivery_address{transition: 1s all ease;transform-origin: top; {{$order_delivery==1 ? 'transform:scaleY(1);height:100%;' :'transform:scaleY(0); display: none; height:0;'}} }
        .design_bg {padding: 25px 7px;background-size: cover !important;background-position: center !important; position: relative; margin:0 0 2px  0 !important;}
        .design_bg .border-right{padding: 25px 10px; border-right: 2px solid red !important;}
        .design_bg::after {position: absolute;content: '';width: 2px;height: 100%;background: #fff;right: 0;top: 0;}                       .design_bg label {color: #fff}
    </style>
                    ...
                    <div class="row my-3" style="background: linear-gradient(34deg, #ddddd08, #f3f3f3">
                        <div class="col-xl-12 text-center text-warning"><h4 class="heading pb-3 mb-4">Personal/Identicaton Info </h4></div>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                @error('mobile_number') <div class="text-danger">{!!$message!!}</div>@else <div class="invalid-feedback"> Valid mobile no is required.</div> @enderror
                            </div>
