...
<div class="container-fluid" id="CustomContainer">↓
    ...
    @endif
    @if (Session::has('msg'))
    <div id="success-msg-dismiss"
        class="alert d-inline alert-{!! Session::get('msg')['alert'] !!} toast-top-right position-fixed alert-dismissible fade show"
        style=" z-index:8888;" role="alert">
    ...
    <script>
        window.setTimeout(function() {$("#success-msg-dismiss").fadeTo(500, 0).slideUp(500, function(){$(this).remove();});}, 3000);
    </script>
    @endif
    @if ($errors->any())
        ...
        <div style="transition: 1s all ease" class="col-xl-12 " id="right_sidebar">
            <div class="row btn-primary-invarce alert">
                <div class="col-xl-4 col-sm-6 col-12 text-center">
                    <a class="btn btn-outline-success" href="{{route('new.customer')}}"><i class="fas fa-user"></i> নতুন
                        গ্রাহক</a>
                </div>
                <div class="col-xl-4 col-sm-6 col-12 text-center">
                    <a class="btn btn-outline-primary text-light" target="_blank"
                        href="{{route('customer.customers')}}"><i class="fas fa-users"></i> সকল গ্রাহক</a>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-xl-12">
            <h3>নতুন গ্রাহক, নতুন অর্ডার তৈরি করুন!</h3>
        </div>
            ...
            <div class="stepwizard-row setup-panel">
                ...
                <div class="multi-wizard-step">
                    <a href="#step-3" type="button" class="btn {{ $currentStep != 3 ? 'btn-default' : 'btn-primary' }}"
                        disabled="disabled">৩</a>
                    <p style="color:#{{ $currentStep != 3 ? 'ddd' : '8a03c0' }}; line-height:18px;">ডিজাইনসমূহ</p>
                </div>
                <div class="multi-wizard-step">
                    <a href="#step-4" type="button" class="btn {{ $currentStep != 4 ? 'btn-default' : 'btn-primary' }}"
                        disabled="disabled">৪</a>
                    <p style="color:#{{ $currentStep != 4 ? 'ddd' : '8a03c0' }}; line-height:18px;">অর্ডারের মজুরি ও
                        ডেলিভারি</p>
                </div>
                <div class="multi-wizard-step">
                    <a href="#step-4" type="button" class="btn {{ $currentStep != 5 ? 'btn-default' : 'btn-primary' }}"
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="personal_information">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        ...
                                        <input type="date"
                                            ...
                                            wire:model="delivery_date" id="deliverydate" required>

                                        @error('delivery_date') <div class="invalid-feedback">{!!$message!!}</div>
                                        @else
                                        @if ($delivery_date &&
                                        $weekendholiday==Carbon\Carbon::now('Asia/Dhaka')->createFromFormat('Y-m-d',
                                        $delivery_date)->format('l'))
                                        ...
                                        <div class="row">
                                            <div class="col-lg-9">
                                                <label for="order_number" style="letter-spacing:px">অর্ডার নং- <span
                                                        ...
                                                        @else 0 @endif)</span></label>
                                                <input type="number"
                                                    class="form-control @error('order_number') is-invalid @enderror"
                                                    @if(!$force_id) min="{{!$force_id ? $maxOrderId: $order_number}}"
                                                    max="{{$maxOrderId}}" @endif wire:model="order_number"
                                                    id="order_number" required>
                                                @error('order_number')<div class="invalid-feedback">{!!$message!!}</div>
                                                @enderror
                                            </div>
                                            <div class="col-lg-3">
                                ...
                                <div class="row my-3 " style="background: linear-gradient(34deg, #ddddd08, #f3f3f3">
                                    <div class="col-xl-12 text-center text-warning">
                                        <h4 class="heading pb-3 mb-4">ব্যক্তিগত/পরিচয় সংক্রান্ত তথ্য </h4>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <label for="fullname">অর্ডারকারীর পুরো নামঃ</label>
                                        <input wire:model="Full_Name" type="text" class="form-control" id="fullname"
                                            placeholder="পুরো নাম" required>
                                        @error('Full_Name') <div class="text-danger">{!!$message!!}</div>@else <div
                                            class="invalid-feedback"> সঠিকভাবে নাম পূরণ করুন</div> @enderror
                                    </div>

                                    <div class="col-lg-6 mb-3">
                                        <label for="mobileNumber">মোবাইল নম্বর</label>
                                        <input wire:model="mobile" type="number"
                                            class="form-control @error('mobile') is-invalid @enderror" id="mobileNumber"
                                            placeholder="019xxxxxxxx/88019xxxxxxxx/88019xxxxxxxx" required>
                                        <div class="invalid-feedback">@error('mobile'){!!$message!!}@else সঠিক মোবাইল
                                            নম্বর দিন!@enderror</div>
                                    </div>
                                        ...
                                        <label for="email" class="d-flex">ইমেইল <span class="text-muted">(অপশনাল)</span>
                                            <div class="col-lg-12 d-inline-block d-flex">
                                                <div class="custom-checkbox d-inline-block d-flex">
                                                    <input type="checkbox" class="custom-control-input" id="confirmmail"
                                                        value="1" wire:model='confirm_mail'>
                                                    <label class="custom-control-label ml-3"
                                                        style="color: @error('email') #e74a3b @else #a9a6a6 @enderror !important;"
                                                        for="confirmmail">আপনি কাস্টমারকে ইমেইল পাঠাতে চাচ্ছেন?</label>
                                                </div>
                                            </div>
                                        </label>
                                        <input wire:model="email" type="email" class="form-control" id="email"
                                            placeholder="you@example.com" {{ $confirm_mail ?'required':'' }}>

                                        <div class="invalid-feedback">@error('email') {!! $message!!} @else সঠিক ইমেইল
                                            যুক্ত করুন@enderror</div>
                                    </div>
                                    <div class="col-lg-6 mb-3 customer_photo">
                                        ...
                                        <div class="input-group input_customer_photo" style="positon:relative;">
                                            ...
                                            @error('photo') <div class="text-danger">{!!$message!!}</div> @else <div
                                                class="invalid-feedback">সঠিক ছবি যুক্ত করুন! ছবির ধরন (jpg, jpeg, png)!
                                            </div>@enderror
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        ...
                                        <textarea wire:model="address" rows="3" class="form-control" id="cusaddress"
                            ...
                            <div class="col-xl-12 mb-3 ">
                                <div class="row">
                                    <div class="col-xl-6">
                                        @if (!$errors->any() && $products !='' && $quantity !='' && $wages !='' &&
                                        $total !='')
                                        <button type="{{$errors->isEmpty() ? 'submit':'button'}}" {{ $errors->isEmpty()
                                            ? '':'disabled'}} class="btn btn-primary btn-lg btn-block"><i
                                                class="fas fa-plus-cicle"></i> অর্ডার করুন</button>
                                        @else @if ( $formErrorOne==1 ) <h6 class="text-warning">বাধ্যতামূলক ঘরগুলো পূরণ
                                            করুন!</h6> @endif
                                        @endif
                                    ...
                                    <div class="col-xl-6 text-right">
                                        ...
                                        <button style="transition-delay: 500ms; transition:0.4s all ease;"
                                            class="btn btn-primary btn-lg w-75" wire:click="firstStepSubmit"
                                            type="button"><img style="max-width: 25px"
                                                src="{{asset('assets/img/preloader/loading.gif')}}" id="showtoast">
                                            পরবর্তী ধাপ <i class="fa fa-arrow-right"></i> </button>
                                        @else
                                        @if ($currentStep == 1)<img style="height: px"
                                            src="{{asset('assets/img/preloader/dot-preloader.gif')}}"> @endif
                    ...
                    <div class="col-xl-12 {{ $currentStep != 2 ? 'display-none' : '' }} ">
                        <div class="cloth_part_style">
                            <div class="row">
                                <div
                                    class="col-lg-12 py-5 @error('products')bg-warning @enderror product_name cloth_name">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-sm-2 col-xs-6" style="position: relative;">
                                            <div class="custom-control custom-checkbox mb-1 d-inline-block">
                                                <input type="radio" wire:model="products" name="dresses"
                                                    value="{{$product->id}}"
                                                    class="custom-control-input @error('products')form-control is-invalid @enderror"
                                                    id="product_{{$product->id}}"
                                                    {{--sizeof($products)==0?'required':''--}}>
                                                <label class="custom-control-label"
                                                    for="product_{{$product->id}}">{{$product->name}} <img
                                ...
                                <div class="col-xl-12">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 mb-3">
                                            ...
                                            <select wire:model="fixed_size" class="custom-select d-block w-100"
                                            ...
                                            @error('fixed_size')<div class="text-danger"> {!!$message!!}</div> @else<div
                                ...
                                <div class="col-lg-12 pt-4">
                                    <div class="row">
                                        <div class="col-lg-2 mb-3">
                                            ...
                                            <input wire:model="cloth_long" type="text" class="form-control"
                                ...
                                <div class="col-xl-12 mt-3">
                                    <div class="row">
                                        <div class="col-xl-6 col-12"><button
                                                class="btn btn-danger nextBtn btn-lg col-12 col-mb-2" type="button"
                                                wire:click="back(1)"><i class="fa fa-arrow-left"></i> পেছনের
                                                ধাপ</button></div>
                                        @if ($errors->isEmpty() || $currentStep ==2)
                                        <div class="col-xl-6 col-12">
                                            <button class="btn btn-primary btn-lg w-100 " type="button"
                                                wire:click="measurementSubmit"><img style="max-width: 25px"
                                                    src="{{asset('assets/img/preloader/loading.gif')}}"> পরবর্তী ধাপ <i
                                                    class="fa fa-arrow-right"></i></button>
                                        </div>

                                        @else <div class="col-xl-6 col-12 text-cente">
                                            <h6 class="col-xl-12 text-danger">
                                                <marquee direction="right">বাধ্যতামূলক ঘরগুলো পূরণ করুন!</marquee>
                                            </h6>
                                        </div>
                                        @endif
                    ...
                    <div class="col-xl-12 {{ $currentStep != 3 ? 'display-none' : '' }} ">
                        <div class="col-md-12 step-3">
                            <h5 class="d-block">কাপড়/পোষাক/অ্যাপ্রন <b class="text-info">ডিজাইন</b> সমূহের নাম ও পরিমাপ
                            </h5>
                            ...
                            <div class="row py-1">
                                ...
                                <div class="col-xl-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-sm-6 design_bg sarwani"
                                            style="background:url({{asset('assets/img/')}})">
                                            <div class="custom-control custom-checkbox mb-1 d-inline-block">
                                                <input type="checkbox" wire:model="designs_check.{{ $style->id }}"
                                                    wire:change="fillEmptyStyleField({{$style->id}})"
                                                    value="{{ $style->id }}" class="custom-control-input "
                                                    id="style_{{$style->id}}" @if( in_array( $style->id,
                                                array_keys($design_fields) , true) && $design_fields[$style->id] !=
                                                '')required @endif>
                                                <label class="custom-control-label"
                                                    for="style_{{$style->id}}">{{$style->name}} </label>
                                                <div class="invalid-feedback"> <i class="fa fa-check "
                                                        style="color:#34E3A4"></i> টিক দিন!</div>
                                                @error("designs_check.$style->id") <div class="text-danger">
                                                    {!!$message!!}</div> @enderror
                                                <textarea rows="1" wire:model="design_fields.{{ $style->id }}" rows="1"
                                                    class="form-control" value="{{$style->id}}"></textarea>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="col-xl-12 mt-3">
                                <div class="row">
                                    <div class="col-xl-6 col-12"><button
                                            class="btn btn-danger nextBtn btn-lg col-12 col-mb-2" type="button"
                                            wire:click="back({{$currentStep-1}})"><i class="fa fa-arrow-left"></i>
                                            পেছনের ধাপ</button></div>
                                    {{-- $cloothDesignOutpurResult==0 && --}}
                                    @if ($errors->isEmpty())
                                    <div class="col-xl-6 col-12">
                                        <button class="btn btn-primary btn-lg w-100" type="button"
                                            wire:click="designStepSubmit">পরবর্তী ধাপ <i
                                                class="fa fa-arrow-right"></i></button>
                                    </div>

                                    @else <div class="col-xl-6 col-12 text-center">
                                        <h6 class="col-xl-12 text-danger">
                                            <marquee direction="right">বাধ্যতামূলক ঘরগুলো পূরণ করুন!</marquee>
                                        </h6>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="col-xl-12 d-flex form-group ">
                                    <div class="form-check custom-radio d-flex">
                                        ...
                                        <label class="custom-control-label" style="color: #848487 !important;"
                                            for="otherDelivery">অন্য কোনো মাধ্যমে আপনার পণ্য ডেলিভারি হবে?</label>
                                    </div>
                                </div>
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2">
                                                    <h6 class="text-center border-bottom mb-2 pb-1">পরিমাণ
                                                        @error('quantity')<span class="text-danger">
                                                            দিন!</span> @enderror </h6>
                                                    <p><input type="number" min="1" wire:model="quantity"
                                                            class="form-control" placeholder="পরিমাণ" required></p>
                                                </div>

                                                <div class="col-lg-2">
                                                    <h6 class="text-center border-bottom mb-2 pb-1">@error('wages')<span
                                                            class="text-danger">{{$message}}</span> @else মজুরি
                                                        @enderror </h6>
                                                    <p>
                                                        <input type="number" wire:model="wages" class="form-control"
                                                ...
                                                <div class="col-lg-2">
                                                    <h6 class="text-center border-bottom mb-2 pb-1">অগ্রিম
                                                        ...
                                                        @enderror </h6>
                                                    <p><input type="number" wire:model="advance" class="form-control"
                                                            placeholder="অগ্রিম.."></p>
                                                </div>
                                                <div class="col-lg-2">
                                                    <h6 class="text-center border-bottom mb-2 pb-1">মোট</h6>
                                                    <p><input type="number" wire:model="total" class="form-control"
                            ...
                            <div class="col-xl-12 mt-3">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-12">
                                        <button class="btn btn-primary btn-lg w-100" type="button"
                                            wire:click="wagesStepSubmit">পরবর্তী ধাপ <i
                                                class="fa fa-arrow-right"></i></button>
                                    </div>
                                    @else <div class="col-xl-6 col-12 text-center">
                                        <h6 class="col-xl-12 text-danger">
                                            <marquee>বাধ্যতামূলক ঘরগুলো পূরণ করুন!</marquee>
                                        </h6>
                                    </div>
                                    @endif
                    ...
                    <div class="col-lg-12 {{ $currentStep != 5 ? 'display-none' : '' }} ">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <h3 class="text-warning text-center mb-3 border-bottom pb-2">পুনরায় সকল তথ্য যাচাই করুন
                                </h3>
                            </div>
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-12">ডেলিভারি তারিখঃ- <span
                                            class="text-info">{{$delivery_date}}</span>, <span class="text-info">
                                            @if($weekendholiday=='saturday') শনিবার @elseif ($weekendholiday=='sunday')
                                            রবিবার @elseif ($weekendholiday=='monday') সোমবার
                                            @elseif ($weekendholiday=='tuesday') মঙ্গলবার
                                            @elseif($weekendholiday=='wednesday')বুধবার
                                            @elseif ($weekendholiday=='Thursday') বৃহস্পতিবার
                                            @elseif($weekendholiday=='friday') শুক্রবার @endif </div>
                                    <div class="col-lg-4 col-sm-12"> অর্ডার নং- <span
                                            class="text-info">{{$order_number}}</span></div>
                                    <div class="col-lg-4 col-sm-12">অর্ডারঃ <span class="text-info">{{$products ?
                                            DB::table('products')->find($products)->name : ''}}</span></div>
                                    <div class="col-lg-12 border-top border-secondary my-3"></div>

                                    <div class="col-lg-2 col-sm-4">লম্বা- <span class="text-info">{{$cloth_long}}</span>
                                    </div>
                                    <div class="col-lg-2 col-sm-4">
                                        <div class="row">
                                            <div class="col-lg-12">বডি- <span class="text-info">{{$cloth_body}}</span>
                                            </div>
                                            <div class="col-lg-12">বডির লুজ- <span
                                                    class="text-info">{{$body_loose}}</span></div>
                                            <div class="col-lg-12">পেট- <span class="text-info">{{$cloth_belly}}</span>
                                            </div>
                                            <div class="col-lg-12">পেটের লুজ- <span
                                                    class="text-info">{{$belly_loose}}</span></div>
                                            <div class="col-lg-12">ঘের- <span
                                                    class="text-info">{{$cloth_enclosure}}</span></div>
                                    ...
                                    <div class="col-lg-2 col-sm-4">
                                        <div class="row">
                                            <div class="col-lg-12">হাতা- <span class="text-info">{{$hand_long}}</span>
                                            </div>
                                            <div class="col-lg-12">হাতার মুহুরী- <span
                                                    class="text-info">{{$sleeve_enclosure}}</span></div>
                                            <div class="col-lg-12">মোরা- <span class="text-info">{{$cloth_mora}}</span>
                                            </div>
                                            <div class="col-lg-12">হাতায় পেস্টিং- <span
                                                    class="text-info">{{$sleeve_pasting}}</span></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-sm-4">
                                        <div class="row">
                                            <div class="col-lg-12 col-sm-4">গলা- <span
                                                    class="text-info">{{$cloth_throat}}</span></div>
                                            <div class="col-lg-12 col-sm-4">কলার- <span class="text-info">
                                                    @if ($cloth_collar){{$cloth_collar}} {{$collar_measure_type==1 ?
                                                    'মোট':'সাধারণ'}} @endif </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-sm-4">পুট- <span
                                            class="text-info">{{$cloth_shoulder}}</span></div>
                                    <div class="col-lg-2 col-sm-4">নক সহ- <span class="text-info">{{$noke_shoho}}</span>
                                    </div>
                                    <div class="col-lg-12">সংযোজিত- <span
                                            class="text-info">{{$cloth_additional}}</span></div>
                                    <div class="col-lg-12 border-top border-secondary my-3"></div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    @php
                                    if (count(array_filter($designs_check))>0) {
                                    $filter1 = array_filter($designs_check);
                                    $filter2 = array_filter($design_fields);
                                    $newArr = [];
                                    $firstKeyofArr = array_keys($filter1);
                                    for ($i=0; $i < count($filter1); $i++) { if (in_array($firstKeyofArr[$i],
                                        array_keys($filter2))) {
                                        $newArr[$firstKeyofArr[$i]]=$filter2[$firstKeyofArr[$i]]; }else {
                                        $newArr[$firstKeyofArr[$i]]="" ; } } } @endphp <div class="row">
                                        <div class="col-lg-12 col-sm-12">
                                            @for($it=0; $it < count($newArr); $it++) <span
                                                class="text-secondary d-inline-block" style="max-width:100%"><b
                                                    class="text-primary">({{$it+1}})</b>
                                                {{DB::table('style_measure_parts')->find(array_keys($newArr)[$it])->name}}<span
                                                    class="text-info">-{{$newArr[array_keys($newArr)[$it]]}}</span>{{count($newArr)===$it+1?
                                                " |" :" , "}}</span>
                                                @endfor
                            ...
                            <div class="col-lg-12 mb-3">
                                <div class="row">
                                    <div class="col-lg-2">কুরিয়ার তথ্যঃ- <span class="text-info">{{$wages}}</span>
                                    </div>
                                    <div class="col-lg-2">কুরিয়ার চার্জঃ- <span
                                            class="text-info">{{$delivery_charge}}</span></div>
                                    <div class="col-lg-8">কাস্টমারের তথ্যঃ- <span class="text-info">{{$line2?
                                            $line2.", ":''}}{{$line1}}-{{$zipcode}}, {{$city}}, {{$province}},
                                            {{$country}}</span></div>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="col-lg-12 mb-3">
                                <div class="row">
                                    <div class="col-lg-2">অর্ডারের পরিমানঃ <span class="text-info">{{$quantity}}</span>
                                    </div>
                                    <div class="col-lg-2">একটির মজুরিঃ <span class="text-info">{{$wages}}</span>
                                    </div>

                                    <div class="col-lg-2">ছাড়ঃ <span class="text-info">{{$discount}}</span>
                                    </div>
                                    <div class="col-lg-2">মোট: @if ($wages && $quantity) <span
                                            class="text-info">{{$total}}</span>@endif</div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-4 col-sm-12"><button
                                        class="display-inline-block btn btn-success nextBtn btn-lg col-12 col-mb-2 "
                                        type="button" wire:click="back({{$currentStep-1}})"><i
                                            class="fa fa-arrow-left"></i> পেছনের ধাপ</button></div>
                                <div class="col-lg-4 col-sm-12 mb-2"><a style="margin-top:1px;"
                                        class="btn btn-danger d-block btn-lg" href="{{route('new.customer')}}"><i
                                            class="fas fa-minus-circle"></i></i>
                                        সকল তথ মুছে ফেলুন</a></div>
                                <div class="col-lg-4 col-sm-12">@if (!$errors->any())
                                    <button type="{{$errors->isEmpty() ? 'submit':'button'}}" {{ $errors->isEmpty() ?
                                        '':'disabled'}} class="btn btn-primary btn-lg
                                        btn-block"><i class="fas fa-plus-cicle"></i> অর্ডার করুন</button>
