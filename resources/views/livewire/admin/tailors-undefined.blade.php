<div>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
          <a class="nav-link {{--{!!$activatedNav=='newrole' ? 'active': '' !!}--}}" id="new_role" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><input name="tabactivate" value="newrole" type="radio" wire:click.prevent="navTabsActive('newrole')"  {{--{!!$activatedNav=='newrole' ? 'checked': '' !!}--}}> New Role</a>
        </li>
