    ...
    if (data) {
      ...
      for (const item of data) {
        ...
        if (
          ...
          T_CASH_IN += item.cash_in;
        }
        setReport((p) => ({
          ...p,
          cash_in: (p?.cash_in || 0) + item.cash_in,
          cash_out: (p?.cash_out || 0) + item.cash_out,

          today_cash_in: T_CASH_IN,
          // today_cash_out: (p?.cash_out || 0) + item.cash_out,
        }));
      }
    }
  }, [data]);
