...
import { orderDownMeasurementFields } from '../../arrayForms/orderFields';
// import { useForm } from 'react-hook-form';
const OrderMeasuementDown = ({ register, errors, gqlErrs, onFocus }) => {
  // const {
  //   register,
  //   handleSubmit,
  //   reset,
  ...
  return (
    <div className={csses.orderMeasuementFields}>
      {orderDownMeasurementFields?.map((field) => {
...
export default OrderMeasuementDown;
